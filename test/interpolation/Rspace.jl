...
@testitem "generate_Rspace MDRS" begin
    ...
    wsvec = read_w90_wsvec_dat(dataset"Si2_valence/outputs/MDRS/Si2_valence_wsvec.dat")
    tbdat = read_w90_tb_dat(dataset"Si2_valence/outputs/MDRS/Si2_valence_tb.dat")
